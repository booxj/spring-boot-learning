...
public class DruidDataSourceConfig {
    ...
    public DataSource dataSource() throws SQLException {
        ...
        if (!StringUtils.isEmpty(druidSettings.getPublickey())) {
            druidSettings.setConnectionProperties("config.decrypt=true;config.decrypt.key=" + druidSettings.getPublickey());
        }
